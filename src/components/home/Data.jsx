...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title"><span class="color">V</span>arun <span class="color">S</span>ethi
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Data Scientist / Data Analyst</h3>
            <p className="home__description">Data Science enthusiast based in Bhopal.<br></br>A guy who always look for the data driven approch to solve any real life problem.</p>

            <a href="#contact" className="button button--flex" style={{color:"black",fontSize:"20px"}}>
                Say Hola
                <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
